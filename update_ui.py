...
# find @Composable fun GameDialogContent... up to the end of the file or the next big component
...
fun GameSetupScreen(viewModel: SettingsViewModel) {
    ...
    Column(
        ...
        Button(
            ...
            Icon(androidx.compose.material.icons.Icons.AutoMirrored.Filled.ArrowForward, contentDescription = null, tint = Color.White)
        }
    }
}
...
\n""" + ("// ---" if content[start:end].endswith("// ---") else "")
